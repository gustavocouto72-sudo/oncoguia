...
|------|------|-------------|
| ✅ **Confirmado** | 24 | Os eixos concordam com o protocolo, ou foram re-derivados de forma sólida sem afirmação do protocolo a confrontar. |
| 🔴 **Divergência** | 5 | Ao menos um eixo diverge do que o protocolo afirma/pratica. **Exigem decisão.** |
| 🟡 **Incompleto** | 31 | Lacuna real de fonte que trava consumo pelo app (sem estudo-pivô rastreável e/ou sem critérios de elegibilidade computáveis). |
